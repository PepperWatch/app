...
export default class VideoCanvas {
	constructor({file, blurValue = 0.01}) {
		Object.assign(this, {file, blurValue});
		...
		// 	this.blurValue = 0.01;
		// }
		// this.blurValue = params.blurValue || 0.01;
		...
		const loop = ()=>{
			if (this._ctx) {
				...
				if (this.blurValue) {
					...
					if (this._recordStartedAt && !!false) { // commented out blur shift
